...
if __name__ == "__main__":
    ...
    coml_params = {}
    coml_params['pnorm'] = convert_p_qbar(train_results['pnorm'])
    coml_params['W'] = train_results['model']['W']
    coml_params['b'] = train_results['model']['b']
    coml_params['Λ'] = params_to_posdef(train_results['controller']['Λ'])
    coml_params['K'] = params_to_posdef(train_results['controller']['K'])
    coml_params['P'] = params_to_posdef(train_results['controller']['P'])

    def adaptation_law(q, dq, R_flatten, Omega, r, dr, params=coml_params):
        # Regressor features
    ...
    def controller(q, dq, r, dr, ddr, f_hat, params=coml_params, type='adaptive'):
        if type == 'adaptive':
            # Auxiliary signals
    ...
    def loop(t, q, dq, R_flatten, Omega, r, dr, ddr, params=coml_params):
        pA_prev = ...
        t_prev = ...
        dA_prev = ...
